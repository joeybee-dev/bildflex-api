    ...
    <div class="container">
      <div class="card auth-card border-0 shadow-sm">
        <div class="auth-header text-center">
          ...
          <p class="auth-subtitle mb-0">View inquiries sent to your supplier account.</p>
        </div>
            ...
            <div v-for="inquiry in inquiries" :key="inquiry._id" class="col-12 col-lg-6">
              <div class="content-card h-100">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                  ...
                  <router-link :to="`/supplier/inquiries/${inquiry._id}`" class="btn login-btn btn-sm px-3">
                    View Details
                  </router-link>
                </div>
              </div>
...
const fetchInquiries = async () => {
  try {
    loading.value = true;
    const response = await api.get("/suppliers/inquiries");
