    ...
    <div class="container">
      <div class="card auth-card border-0 shadow-sm">
        <div class="auth-header text-center">
          ...
          <p class="auth-subtitle mb-0">Review messages and replies for your supplier account.</p>
        </div>
        ...
        <div class="card-body p-4 p-md-5">
          ...
          <div v-else class="list-group custom-list-group">
            <router-link
              ...
              :key="message._id"
              :to="`/supplier/messages/${message._id}`"
...
const fetchMessages = async () => {
  try {
    loading.value = true;
    const response = await api.get("/suppliers/messages");
