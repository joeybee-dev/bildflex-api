        ...
        <div class="col-12 col-md-9 col-lg-7">
          <div class="card auth-card border-0 shadow-sm">
            <div class="auth-header text-center">
              <h2 class="auth-title mb-2">Register Supplier</h2>
              <p class="auth-subtitle mb-0">
                Create your supplier account and showcase your products and services.
              </p>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
              <form @submit.prevent="registerSupplier">
                <div class="row g-3">
                  ...
                  <div class="col-12 col-md-6">
                    ...
                    <input v-model.trim="form.category" type="text" class="form-control" placeholder="e.g. Electrical Supplies" />
                  </div>
              ...
              <p class="text-center auth-footer-text mt-4 mb-0">
                ...
                <router-link to="/supplier/login" class="auth-link">Login here</router-link>
              </p>
            </div>
          </div>
        </div>
