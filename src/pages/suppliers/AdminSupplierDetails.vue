    ...
    <div class="container">
      <div class="card auth-card border-0 shadow-sm">
        <div class="auth-header text-center">
          <h2 class="auth-title mb-2">Admin Supplier Details</h2>
          <p class="auth-subtitle mb-0">Review supplier account information.</p>
        </div>
          ...
          <div v-else class="row g-4">
            ...
            <div class="col-12 col-md-6">
              <div class="info-box">
                ...
                <div>{{ supplier.isActive === false ? "Inactive" : "Active" }}</div>
              </div>
            </div>
            ...
            <div class="col-12">
              <router-link to="/admin/suppliers" class="btn login-btn">Back to Admin Suppliers</router-link>
            </div>
          </div>
        </div>
      </div>  
