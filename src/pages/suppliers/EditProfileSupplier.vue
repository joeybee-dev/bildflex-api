        ...
        <div class="col-12 col-lg-8">
          <div class="card auth-card border-0 shadow-sm">
            <div class="auth-header text-center">
              <h2 class="auth-title mb-2">Edit Supplier Profile</h2>
              <p class="auth-subtitle mb-0">Update your supplier information.</p>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
              <form @submit.prevent="updateProfile">
                <div class="row g-3">
                  ...
                  <div class="col-12"><label class="form-label">Category</label><input v-model.trim="form.category" class="form-control" type="text" /></div>
...
const fetchProfile = async () => {
  try {
    ...
    Object.assign(form, {
      ...
      aboutBusiness: supplier.aboutBusiness || ""
    });
  } catch (err) {
...
const updateProfile = async () => {
  try {
    loading.value = true;
    const response = await api.patch("/suppliers/update-profile", form);
