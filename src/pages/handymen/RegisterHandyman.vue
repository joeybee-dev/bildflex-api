          ...
          <div class="card auth-card border-0 shadow-sm">
            <div class="auth-header text-center">
              ...
              <p class="auth-subtitle mb-0">
                Create your handyman account and start offering your services.
              </p>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
              <form @submit.prevent="registerHandyman">
                <div class="row g-3">
                  ...
                  <div class="col-12 col-md-6">
                    ...
                    <input v-model.trim="form.specialization" type="text" class="form-control" placeholder="e.g. Plumbing, Electrical, Carpentry" />
                  </div>
              ...
              <p class="text-center auth-footer-text mt-4 mb-0">
                ...
                <router-link to="/handyman/login" class="auth-link">Login here</router-link>
              </p>
            </div>
          </div>
        </div>
