        ...
        <div class="col-12 col-md-8 col-lg-5">
          <div class="card auth-card border-0 shadow-sm">
            <div class="auth-header text-center">
              ...
              <p class="auth-subtitle mb-0">Enter your new handyman password.</p>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
              ...
              <p class="text-center auth-footer-text mt-4 mb-0">
                Back to
                <router-link to="/handyman/login" class="auth-link">Login</router-link>
              </p>
            </div>
          </div>
        </div>
...
const submitResetPassword = async () => {
  ...
  try {
    loading.value = true;
    const response = await api.post(`/handymen/reset-password/${route.params.token}`, form);
