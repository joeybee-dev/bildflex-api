        ...
        <div class="col-12 col-lg-8">
          <div class="card auth-card border-0 shadow-sm">
            <div class="auth-header text-center">
              <h2 class="auth-title mb-2">My Handyman Profile</h2>
              <p class="auth-subtitle mb-0">View and manage your handyman account.</p>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
              ...
              <div v-else class="row g-4 align-items-start">
                <div class="col-12 col-md-4 text-center">
                  ...
                  <router-link to="/handyman/profile/photo" class="btn login-btn w-100">
                    Change Photo
                  </router-link>
                </div>
                ...
                <div class="col-12 col-md-8">
                  <div class="row g-3">
                    <div class="col-12"><div class="info-box"><label class="form-label">Business Name</label><div>{{ handyman.businessName || "-" }}</div></div></div>
                    <div class="col-12 col-md-6"><div class="info-box"><label class="form-label">Contact Person</label><div>{{ handyman.contactPerson || "-" }}</div></div></div>
                    <div class="col-12 col-md-6"><div class="info-box"><label class="form-label">Email</label><div>{{ handyman.email || "-" }}</div></div></div>
                    <div class="col-12 col-md-6"><div class="info-box"><label class="form-label">Mobile Number</label><div>{{ handyman.mobileNumber || "-" }}</div></div></div>
                    <div class="col-12 col-md-6"><div class="info-box"><label class="form-label">City</label><div>{{ handyman.city || "-" }}</div></div></div>
                    <div class="col-12"><div class="info-box"><label class="form-label">Specialization</label><div>{{ handyman.specialization || "-" }}</div></div></div>
                    <div class="col-12"><div class="info-box info-box-lg"><label class="form-label">About Business</label><div>{{ handyman.aboutBusiness || "-" }}</div></div></div>
                  </div>

                  <div class="d-flex flex-column flex-md-row gap-2 mt-4">
                    <router-link to="/handyman/profile/edit" class="btn login-btn">Edit Profile</router-link>
                    <router-link to="/handyman/change-password" class="btn btn-outline-primary custom-outline-btn">Change Password</router-link>
                    <router-link to="/handyman/deactivate-account" class="btn btn-outline-danger custom-danger-btn">Deactivate Account</router-link>
                  </div>
                </div>
              </div>
            </div>
