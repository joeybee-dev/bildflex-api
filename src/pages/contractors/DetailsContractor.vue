    ...
    <div class="container">
      <div class="card auth-card border-0 shadow-sm">
        <div class="auth-header text-center">
          <h2 class="auth-title mb-2">Contractor Details</h2>
          <p class="auth-subtitle mb-0">View contractor profile and business information.</p>
        </div>
        ...
        <div class="card-body p-4 p-md-5">
          ...
          <div v-else class="row g-4 align-items-start">
            <div class="col-12 col-md-4 text-center">
              <img :src="contractor.profilePhoto || fallbackImage" class="profile-image-lg" alt="Contractor" />
            </div>
              ...
              <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                  <div class="info-box">
                    ...
                    <div>{{ contractor.specialization || "-" }}</div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="info-box info-box-lg">
                    ...
                    <div>{{ contractor.aboutBusiness || "-" }}</div>
                  </div>
                </div>
              </div>

              <div class="mt-4">
                <router-link to="/contractors" class="btn login-btn">Back to Contractors</router-link>
              </div>
            </div>
          </div>
        </div>
...
const fetchContractor = async () => {
  try {
    ...
    notyf.error(err.response?.data?.error || "Failed to load contractor details.");
  } finally {
    loading.value = false;
  }
};
