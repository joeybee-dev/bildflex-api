        ...
        <div class="col-12 col-md-9 col-lg-7">
          <div class="card auth-card border-0 shadow-sm">
            <div class="auth-header text-start">
              <h2 class="auth-title mb-1">Register as Contractor</h2>
              <p class="auth-subtitle mb-0">
                Create your contractor account and showcase your projects.
              </p>
            </div>
            ...
            <div class="card-body p-4 p-md-4">
              <form @submit.prevent="registerContractor">
                <div class="row g-3">
                  ...
                  <div class="col-12 col-md-6">
                    ...
                    <input v-model.trim="form.category" type="text" class="form-control" placeholder="e.g. General Construction" />
                  </div>
              ...
              <p class="text-center auth-footer-text mt-4 mb-0">
                ...
                <router-link to="/contractor/login" class="auth-link">
                  Login here
                </router-link>
              </p>
            </div>
