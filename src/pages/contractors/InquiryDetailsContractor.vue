    ...
    <div class="container">
      <div class="card auth-card border-0 shadow-sm">
        <div class="auth-header text-center">
          ...
          <p class="auth-subtitle mb-0">View inquiries sent to your contractor account.</p>
        </div>
        ...
        <div class="card-body p-4 p-md-5">
          ...
          <div v-else-if="inquiries.length === 0" class="empty-state text-center py-5">
            ...
            <p class="text-muted mb-0">Customer inquiries will appear here.</p>
          </div>
              ...
              <div class="content-card h-100">
                <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
                  <div>
                    ...
                    <p class="content-meta mb-0">From: {{ inquiry.senderName || inquiry.senderEmail || "-" }}</p>
                  </div>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                  ...
                  <router-link :to="`/contractor/inquiries/${inquiry._id}`" class="btn login-btn btn-sm px-3">
                    View Details
                  </router-link>
                </div>
              </div>
...
const fetchInquiries = async () => {
  try {
    loading.value = true;
    const response = await api.get("/contractors/inquiries");
