        ...
        <div class="col-12 col-lg-8">
          <div class="card auth-card border-0 shadow-sm">
            <div class="auth-header text-center">
              <h2 class="auth-title mb-2">Edit Contractor Profile</h2>
              <p class="auth-subtitle mb-0">Update your contractor information.</p>
            </div>
...
const fetchProfile = async () => {
  try {
    ...
    Object.assign(form, {
      ...
      aboutBusiness: contractor.aboutBusiness || ""
    });
  } catch (err) {
...
const updateProfile = async () => {
  try {
    loading.value = true;
    const response = await api.patch("/contractors/update-profile", form);
