        ...
        <div class="col-12 col-md-8 col-lg-5">
          <div class="card auth-card border-0 shadow-sm">
            <div class="auth-header text-center">
              ...
              <p class="auth-subtitle mb-0">This will deactivate your contractor account.</p>
            </div>

            <div class="card-body p-4 p-md-5">
              <div class="alert alert-warning rounded-4">
                Are you sure you want to deactivate your contractor account?
              </div>
...
const deactivateAccount = async () => {
  try {
    loading.value = true;
    const response = await api.delete("/contractors/deactivate-account", {
    ...
    notyf.error(err.response?.data?.error || "Failed to deactivate contractor account.");
  } finally {
    loading.value = false;
  }
};
