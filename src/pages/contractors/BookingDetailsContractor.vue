    ...
    <div class="container">
      <div class="card auth-card border-0 shadow-sm">
        <div class="auth-header text-center">
          ...
          <p class="auth-subtitle mb-0">Track bookings related to your contractor account.</p>
        </div>
        ...
        <div class="card-body p-4 p-md-5">
          ...
          <div v-else-if="bookings.length === 0" class="empty-state text-center py-5">
            ...
            <p class="text-muted mb-0">Bookings will appear here.</p>
          </div>
            ...
            <div v-for="booking in bookings" :key="booking._id" class="col-12 col-lg-6">
              <div class="content-card h-100">
                <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
                  <div>
                    <h5 class="content-title mb-1">{{ booking.serviceTitle || booking.title || "Booking" }}</h5>
                    <p class="content-meta mb-0">Customer: {{ booking.customerName || booking.userName || "-" }}</p>
                  </div>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                  ...
                  <router-link :to="`/contractor/bookings/${booking._id}`" class="btn login-btn btn-sm px-3">
                    View Details
                  </router-link>
                </div>
              </div>
...
const fetchBookings = async () => {
  try {
    loading.value = true;
    const response = await api.get("/contractors/bookings");
