        ...
        <div class="col-12 col-lg-8">
          <div class="card auth-card border-0 shadow-sm">
            <div class="auth-header text-center">
              <h2 class="auth-title mb-2">Edit Designer Profile</h2>
              <p class="auth-subtitle mb-0">Update your designer information.</p>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
              <form @submit.prevent="updateProfile">
                ...
                <div class="d-flex flex-column flex-md-row gap-2 mt-4">
                  ...
                  <router-link to="/designer/profile" class="btn btn-outline-secondary custom-outline-btn">Cancel</router-link>
                </div>
              </form>
            </div>
          </div>
...
const fetchProfile = async () => {
  try {
    ...
    Object.assign(form, {
      ...
      contactPerson: designer.contactPerson || "",
      mobileNumber: designer.mobileNumber || "",
      city: designer.city || "",
      specialization: designer.specialization || "",
      aboutBusiness: designer.aboutBusiness || ""
    });
  } catch (err) {
...
const updateProfile = async () => {
  try {
    loading.value = true;
    const response = await api.patch("/designers/update-profile", form);
