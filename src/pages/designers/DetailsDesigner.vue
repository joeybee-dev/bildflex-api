    ...
    <div class="container">
      <div class="card auth-card border-0 shadow-sm">
        <div class="auth-header text-center">
          <h2 class="auth-title mb-2">Designer Details</h2>
          <p class="auth-subtitle mb-0">View designer profile and company information.</p>
        </div>
        ...
        <div class="card-body p-4 p-md-5">
          ...
          <div v-else class="row g-4 align-items-start">
            <div class="col-12 col-md-4 text-center">
              <img :src="designer.profilePhoto || fallbackImage" class="profile-image-lg" alt="Designer" />
            </div>
            ...
            <div class="col-12 col-md-8">
              ...
              <div class="mt-4">
                <router-link to="/designers" class="btn login-btn">Back to Designers</router-link>
              </div>
            </div>
          </div>
        </div>
...
const fetchDesigner = async () => {
  try {
    loading.value = true;
    const response = await api.get(`/designers/${route.params.id}`);
