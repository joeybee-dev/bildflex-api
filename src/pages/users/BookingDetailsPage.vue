    ...
    <div class="container">
      <div class="card auth-card border-0 shadow-sm">
        <div class="auth-header text-center">
          ...
          <p class="auth-subtitle mb-0">Review your booking information.</p>
        </div>
          ...
          <div v-else class="row g-4">
            ...
            <div class="col-12 col-md-6">
              <div class="info-box">
                ...
                <div>{{ booking.professionalName || booking.providerName || "-" }}</div>
              </div>
            </div>
            ...
            <div class="col-12">
              <router-link to="/my-bookings" class="btn login-btn">Back to My Bookings</router-link>
            </div>
          </div>
        </div>
      </div>  
...
const fetchBooking = async () => {
  try {
    loading.value = true;
    const response = await api.get(`/bookings/my-bookings/${route.params.id}`);
