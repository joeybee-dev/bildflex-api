    ...
    <div class="container">
      <div class="card auth-card border-0 shadow-sm">
        <div class="auth-header text-center">
          ...
          <p class="auth-subtitle mb-0">Review the full details of your inquiry.</p>
        </div>
          ...
          <div v-else class="row g-4">
            ...
            <div class="col-12 col-md-6">
              <div class="info-box">
                ...
                <div>{{ inquiry.recipientName || inquiry.professionalName || "-" }}</div>
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="d-flex flex-wrap gap-2">
                <router-link to="/my-inquiries" class="btn login-btn">Back to My Inquiries</router-link>
              </div>
            </div>
          </div>
        </div>
...
const fetchInquiry = async () => {
  try {
    loading.value = true;
    const response = await api.get(`/inquiries/${route.params.id}`);
